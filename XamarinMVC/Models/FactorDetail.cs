...
namespace XamarinMVC.Models
{
    public class FactorDetail
    {
        ...
        [Display(ResourceType = typeof(XamarinMVC.App_GlobalResources.Captions), Name = "FactorId")]
        ...
        [Required(ErrorMessageResourceName = "Required", ErrorMessageResourceType = typeof(XamarinMVC.App_GlobalResources.Errors))]
        [Display(ResourceType = typeof(XamarinMVC.App_GlobalResources.Captions), Name = "Count")]
        public int Count { get; set; }

        [Required(ErrorMessageResourceName = "Required", ErrorMessageResourceType = typeof(XamarinMVC.App_GlobalResources.Errors))]
        [Display(ResourceType = typeof(XamarinMVC.App_GlobalResources.Captions), Name = "DetailPrice")]
