...
namespace DataAccessLayer.Models
{
    public class ProductField
    {
        ...
        [Display(ResourceType = typeof(DataAccessLayer.App_GlobalResources.Captions), Name = "FieldId")]
        public int FieldId { get; set; }

        [Display(ResourceType = typeof(DataAccessLayer.App_GlobalResources.Captions), Name = "ENFieldValue")]
        ...
        [Display(ResourceType = typeof(DataAccessLayer.App_GlobalResources.Captions), Name = "FAFieldValue")]
        //[Required(ErrorMessageResourceName = "Required", ErrorMessageResourceType = typeof(DataAccessLayer.App_GlobalResources.Errors))]
        [MaxLength(100, ErrorMessageResourceName = "MaxLength", ErrorMessageResourceType = typeof(DataAccessLayer.App_GlobalResources.Errors))]
