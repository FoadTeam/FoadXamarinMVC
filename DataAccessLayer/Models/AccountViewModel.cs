...
namespace DataAccessLayer.Models
{
    public class RegisterViewModel
    {
        ...
        [Display(ResourceType = typeof(DataAccessLayer.App_GlobalResources.Captions), Name = "RePassword")]
        [MaxLength(50, ErrorMessageResourceName = "MaxLength", ErrorMessageResourceType = typeof(DataAccessLayer.App_GlobalResources.Errors))]
        [Required(ErrorMessageResourceName = "Required", ErrorMessageResourceType = typeof(DataAccessLayer.App_GlobalResources.Errors))]
        [Compare("Password", ErrorMessageResourceName = "ComparePassword", ErrorMessageResourceType = typeof(DataAccessLayer.App_GlobalResources.Errors))]
    ...
    {
        [Display(ResourceType = typeof(DataAccessLayer.App_GlobalResources.Captions), Name = "Code")]
        [MaxLength(6, ErrorMessageResourceType = typeof(DataAccessLayer.App_GlobalResources.Errors), ErrorMessageResourceName = "MaxLength")]
        public string Code { get; set; }

        [Display(ResourceType = typeof(DataAccessLayer.App_GlobalResources.Captions), Name = "NewPassword")]
        [MaxLength(50, ErrorMessageResourceName = "MaxLength", ErrorMessageResourceType = typeof(DataAccessLayer.App_GlobalResources.Errors))]
        [Required(ErrorMessageResourceName = "Required", ErrorMessageResourceType = typeof(DataAccessLayer.App_GlobalResources.Errors))]
        public string Password { get; set; }

        [Display(ResourceType = typeof(DataAccessLayer.App_GlobalResources.Captions), Name = "NewRePassword")]
        [MaxLength(50, ErrorMessageResourceName = "MaxLength", ErrorMessageResourceType = typeof(DataAccessLayer.App_GlobalResources.Errors))]
        [Required(ErrorMessageResourceName = "Required", ErrorMessageResourceType = typeof(DataAccessLayer.App_GlobalResources.Errors))]
        [Compare("Password", ErrorMessageResourceName = "ComparePassword", ErrorMessageResourceType = typeof(DataAccessLayer.App_GlobalResources.Errors))]
        public string RePassword { get; set; }
    ...
    {
        [Display(ResourceType = typeof(DataAccessLayer.App_GlobalResources.Captions), Name = "DetailCount")]
